...
@Component({
  selector: 'registry-provider',
  templateUrl: './registry-provider.component.html',
  styleUrls: ['./registry-provider.component.scss']
})
export class RegistryProviderComponent implements OnInit {
  forms: any;
  temp: any;
  registryUser: any;
  user: any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<RegistryProviderComponent>,
